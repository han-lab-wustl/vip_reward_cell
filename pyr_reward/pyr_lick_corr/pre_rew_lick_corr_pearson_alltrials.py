...
def main(params_pth,animal,day):
   ...
   dfs.append(make_corr_df(tcs_correct_abs, lick_correct_abs, vel_correct_abs,coms_rewrel,
                           ...
                           animal=animal, day=day, goal_cells=goal_cells))
   ########## incorrect trials  
...
plt.tight_layout()
plt.savefig(os.path.join(savedst,'single_prerew_lick_pearson.svg'), bbox_inches='tight')
#%%
# velocity?
# pre-reward cell vs. com
# per animal
...
plt.tight_layout()
plt.savefig(os.path.join(savedst,'single_prerew_vel_pearson.svg'), bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(savedst,'prerew_lick_vel_pearson.svg'), bbox_inches='tight')

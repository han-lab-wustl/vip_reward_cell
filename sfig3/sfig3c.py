...
df=pd.read_csv(r'C:\Users\Han\Documents\MATLAB\vip_reward_cell_copy_w_raw_data\raw_data\cell\sfig3.csv')
...
for ep in epochs:
    ...
    if 'reward_cell_p_shuf' in dsub.columns:
        ...
        _, pval = scipy.stats.wilcoxon(
            dsub['reward_cell_p'].values, 
            dsub['reward_cell_p_shuf'].values,alternative='greater')
